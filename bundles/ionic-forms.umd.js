(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     *
     */
    var AjfPopover = /** @class */ (function () {
        function AjfPopover() {
        }
        return AjfPopover;
    }());
    AjfPopover.decorators = [
        { type: i0.Component, args: [{
    ...
    AjfPopover.propDecorators = {
        hint: [{ type: i0.Input, args: ['hint',] }]
    };
    ...
    var AjfFormRenderer = /** @class */ (function (_super) {
        ...
        function AjfFormRenderer(rendererService, cdr, popoverController) {
        ...
        AjfFormRenderer.prototype.openPopover = function (ev, hint) {
            var popover = this.popoverController.create({
                component: AjfPopover,
                cssClass: 'ajf-popover',
                translucent: true,
                event: ev,
                componentProps: { hint: hint }
            });
            popover.then(function (pop) { return pop.present(); });
        };
    ...
    exports.ɵgc_ajf_src_ionic_forms_forms_d = AjfPopover;
    exports.ɵgc_ajf_src_ionic_forms_forms_e = AjfSelectHasSearchBarPipe;
    exports.ɵgc_ajf_src_ionic_forms_forms_f = AjfSelectUseVirtualScroll;
    exports.ɵgc_ajf_src_ionic_forms_forms_g = AjfVideoUrlFieldComponent;
