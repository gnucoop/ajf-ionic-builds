    ...
    ***************************************************************************** */
    ...
    var AjfDateFieldComponent = /** @class */ (function (_super) {
        ...
        AjfDateFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ion-item><ajf-calendar selectionMode=\"day\" dateOnlyForDay [minDate]=\"instance.node.minDate|ajfDateValue\" [maxDate]=\"instance.node.maxDate|ajfDateValue\" [disabled]=\"readonly\" [formControl]=\"control|async\"></ajf-calendar></ion-item>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfDateInputFieldComponent = /** @class */ (function (_super) {
        ...
        AjfDateInputFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ion-input type=\"date\" [min]=\"instance.node.minDate|ajfDateValueString\" [max]=\"instance.node.maxDate|ajfDateValueString\" [readonly]=\"readonly\" (ionChange)=\"onChange($event)\" [formControl]=\"control|async\"></ion-input>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfBarcodeFieldComponent = /** @class */ (function (_super) {
        ...
        AjfBarcodeFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ajf-barcode [formControl]=\"control|async\" [readonly]=\"readonly\"></ajf-barcode>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfInputFieldComponent = /** @class */ (function (_super) {
        ...
        AjfInputFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ion-input [type]=\"type\" [formControl]=\"control|async\" [attr.disabled]=\"readonly\"></ion-input>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfMultipleChoiceFieldComponent = /** @class */ (function (_super) {
        ...
        AjfMultipleChoiceFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ng-container *ngIf=\"!(instance|ajfExpandFieldWithChoices:searchThreshold); else expanded\"><div class=\"ajf-item-container\"><gic-select *ngIf=\"instance.filteredChoices as cs\" #multipleChoiceSelect multiple=\"multiple\" [searchBar]=\"instance|ajfSelectHasSearchBar:searchThreshold\" [useVirtualScroll]=\"instance|ajfSelectUseVirtualScroll:100\" [placeholder]=\"instance.node.label\" [formControl]=\"control|async\" [disabled]=\"readonly\"><gic-select-option *ngFor=\"let item of cs\" [value]=\"item.value\">{{ item.label|translate }}</gic-select-option></gic-select></div></ng-container><ng-template #expanded><div ajf-checkbox-group [formControl]=\"control|async\" class=\"ajf-choices-container\"><ion-card *ngFor=\"let choice of instance.filteredChoices\"><ajf-checkbox-group-item [value]=\"choice.value\">{{ choice.label | translate }}</ajf-checkbox-group-item></ion-card></div></ng-template>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfNumberFieldComponent = /** @class */ (function (_super) {
        ...
        AjfNumberFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ion-input [ngModel]=\"value|async\" (ngModelChange)=\"setValue($event)\" [readonly]=\"readonly\"></ion-input>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
