...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@ionic/angular'), require('@ajf/core/forms'), require('rxjs/operators'), require('@angular/common'), require('@angular/forms'), require('@gic/angular'), require('@ngx-translate/core'), require('@ajf/core/common'), require('@ajf/ionic/calendar'), require('@ajf/ionic/checkbox-group'), require('@ajf/ionic/page-slider')) :
    typeof define === 'function' && define.amd ? define('@ajf/ionic/forms', ['exports', '@angular/core', 'rxjs', '@ionic/angular', '@ajf/core/forms', 'rxjs/operators', '@angular/common', '@angular/forms', '@gic/angular', '@ngx-translate/core', '@ajf/core/common', '@ajf/ionic/calendar', '@ajf/ionic/checkbox-group', '@ajf/ionic/page-slider'], factory) :
    (global = global || self, factory((global.ajf = global.ajf || {}, global.ajf.ionic = global.ajf.ionic || {}, global.ajf.ionic.forms = {}), global.ng.core, global.rxjs, global.ionic.angular, global.ajf.core.forms, global.rxjs.operators, global.ng.common, global.ng.forms, global.gic.angular, global.ngxt.core, global.ajf.core.common, global.ajf.ionic.calendar, global.ajf.ionic.checkboxGroup, global.ajf.ionic.pageSlider));
}(this, function (exports, core, rxjs, angular, forms, operators, common, forms$1, angular$1, core$1, common$1, calendar, checkboxGroup, pageSlider) { 'use strict';
