...
/**
     ...
     *
     */
var W=function(){function e(){}return e.forRoot=function(){return{ngModule:e,providers:[P]}},e}();W.decorators=[{type:t.NgModule,args:[{imports:[s.AjfBarcodeModule,f.AjfCalendarModule,d.AjfCheckboxGroupModule,l.AjfCommonModule,n.AjfFormsModule,p.AjfPageSliderModule,m.AjfTimeModule,g.CommonModule,u.FormsModule,j.GicModule,a.IonicModule,u.ReactiveFormsModule,h.TranslateModule],declarations:[S,b,I,A,F,M,k,B,_,x,R,E,V,G,L,w,D,T,O,N],entryComponents:[S,b,I,A,F,_,x,R,E,V,w,D,T,O,N],exports:[M,B],providers:[P,{provide:n.AJF_WARNING_ALERT_SERVICE,useClass:C}]}]}],
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
e.AjfBooleanFieldComponent=b,e.AjfDateFieldComponent=I,e.AjfDateInputFieldComponent=A,e.AjfEmptyFieldComponent=F,e.AjfFieldService=P,e.AjfFormField=M,e.AjfFormRenderer=B,e.AjfFormsModule=W,e.AjfInputFieldComponent=x,e.AjfMultipleChoiceFieldComponent=R,e.AjfNumberFieldComponent=E,e.AjfSingleChoiceFieldComponent=w,e.AjfTableFieldComponent=D,e.AjfTextareaFieldComponent=T,e.AjfTimeFieldComponent=O,e.AjfWarningAlertService=C,e.ɵgc_ajf_src_ionic_forms_forms_a=S,e.ɵgc_ajf_src_ionic_forms_forms_b=k,e.ɵgc_ajf_src_ionic_forms_forms_c=_,e.ɵgc_ajf_src_ionic_forms_forms_d=V,e.ɵgc_ajf_src_ionic_forms_forms_e=G,e.ɵgc_ajf_src_ionic_forms_forms_f=L,e.ɵgc_ajf_src_ionic_forms_forms_g=N,Object.defineProperty(e,"__esModule",{value:!0})}));