...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ajf/core/reports'), require('@angular/common'), require('@ngx-translate/core'), require('@ajf/core/chart'), require('@ajf/core/common'), require('@ajf/core/page-break'), require('@ajf/core/map'), require('@ajf/core/table'), require('@ajf/core/text'), require('@ajf/ionic/image')) :
    typeof define === 'function' && define.amd ? define('@ajf/ionic/reports', ['exports', '@angular/core', '@ajf/core/reports', '@angular/common', '@ngx-translate/core', '@ajf/core/chart', '@ajf/core/common', '@ajf/core/page-break', '@ajf/core/map', '@ajf/core/table', '@ajf/core/text', '@ajf/ionic/image'], factory) :
    (global = global || self, factory((global.ajf = global.ajf || {}, global.ajf.ionic = global.ajf.ionic || {}, global.ajf.ionic.reports = {}), global.ng.core, global.ajf.core.reports, global.ng.common, global.ngxt.core, global.ajf.core.chart, global.ajf.core.common, global.ajf.core.pageBreak, global.ajf.core.map, global.ajf.core.table, global.ajf.core.text, global.ajf.ionic.image));
}(this, function (exports, core, reports, common, core$1, chart, common$1, pageBreak, map, table, text, image) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    }(reports.AjfReportWidgetRenderer));
