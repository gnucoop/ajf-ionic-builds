...
AjfCalendarModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.4", ngImport: i0, type: AjfCalendarModule, declarations: [AjfCalendarComponent], imports: [CommonModule, AjfCalendarModule$1, FormsModule, IonicModule, AjfTranslocoModule], exports: [AjfCalendarComponent] });
AjfCalendarModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AjfCalendarModule, imports: [CommonModule, AjfCalendarModule$1, FormsModule, IonicModule, AjfTranslocoModule] });
