...
let AjfNumberFieldComponent = /** @class */ (() => {
    let AjfNumberFieldComponent = class AjfNumberFieldComponent extends AjfInputFieldComponent$1 {
        constructor(cdr, service, was) {
            super(cdr, service, was);
...
let AjfTextareaFieldComponent = /** @class */ (() => {
    let AjfTextareaFieldComponent = class AjfTextareaFieldComponent extends AjfBaseFieldComponent {
        constructor(cdr, service, was) {
            super(cdr, service, was);
        }
    };
